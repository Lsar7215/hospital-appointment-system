                ...
                <tr>
                    <td colspan="4">
                        <table border="0" width="90%"">
                            <tr>
                                <td width="40%" style="padding-left:40px;height:250px;vertical-align: top;">
                                    <p style="font-size: 20px;font-weight:600;" class="anime">Status</p>
                                    <div class="dashboard-items filter-container" style="padding:20px;margin-top:15px;width:95%;height:35%;display: flex;justify-content: space-between;align-items:center;background: white;border-radius:20px;box-shadow: 0 0 15px rgba(0,0,0,0.1);">
                                        <div>
                                            ...
                                            <?php
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        <a href="appointment.php" class="non-style-link" style="font-size:25px;font-weight:700;">'.
                                                        $apponum
                                                        .'</a></td>
                                                        ...
                                                        <td style="text-align:center;">
                                                            '.date('d-m-Y', strtotime($scheduledate)).' '.substr($scheduletime,0,5).'
                                                        </td>
