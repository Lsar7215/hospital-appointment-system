...
<head>
    ...
    <style>
        ...
        /* Truncate long specialties with ellipsis and provide full text in a tooltip (title)
           Be responsive: reduce max-width on smaller screens so the column adapts. */
        .specialties-cell{
        ...
        @media (max-width: 1000px){
            .specialties-cell{ max-width: 160px; }
        }
        @media (max-width: 600px){
            /* on small screens allow a bit less width so layout stays tidy */
            .specialties-cell{ max-width: 110px; }
        }
</style>
</head>
<body>
                            ...
                            <?php 
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <!-- email hidden -->
                                        <td>
                                            <span class="specialties-cell" title="'.htmlspecialchars($spcil_name).'">'.htmlspecialchars(substr($spcil_name,0,40)).'</span>
                                        </td>
                ...
                <div id="popup1" class="overlay">
                    <div class="popup">
                        <center>
                            ...
                            <a class="close" href="doctors.php">&times;</a>
                            <div class="content">
                                You want to view All sessions by Dr.'.substr($name,0,40).'?
                            </div>
                <form action="schedule.php" method="post" style="display: flex;justify-content:center;width:100%;">
                    <input type="hidden" name="search" value="'.$name.'">
                <div style="display:flex;justify-content:center;gap:12px;margin-top:6%;margin-bottom:3%;">
                <a href="doctors.php"><input type="button" value="Cancel" class="btn-primary-soft btn"></a>
