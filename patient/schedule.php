     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $searchtype="All";
                        ...
                        // support both POST and GET search (so links can navigate using ?search=...)

                        if(!empty($_POST["search"]) || !empty($_GET["search"])){
                            $keyword = !empty($_POST["search"]) ? $_POST["search"] : $_GET["search"];
        ...
        <div class="dash-body">
            ...
            ?>
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        <div class="abc scroll" style="min-height: 80vh;">
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<($result->num_rows);$x++){
                                    ...
                                    for($q=0;$q<3;$q++){
                                        ...
                                        $bookingsql = "SELECT * FROM appointment WHERE scheduleid = ? AND pid = ?";
                                        $bookingstmt = $database->prepare($bookingsql);
                                        $bookingstmt->bind_param("ii", $scheduleid, $userid);
                                        $bookingstmt->execute();
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h4-search">
                                                                '.date('d-m-Y', strtotime($scheduledate)).'<br>Starts: <b>'.substr($scheduletime,0,5).'</b>
                                                            </div>
                                                            <br>';
                                        if($isBooked) {
                                            echo '<button class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%;opacity:0.6;" disabled><font class="tn-in-text">Already Booked</font></button>';
                                        } else {
